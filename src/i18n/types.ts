...
export type MessageKey =
  ...
  // ----- Lock screen -----
  | "lock.subtitle"
  | "lock.highlights.title"
  | "lock.highlights.thresholdless.label"
  | "lock.highlights.thresholdless.desc"
  | "lock.highlights.secure.label"
  | "lock.highlights.secure.desc"
  | "lock.highlights.local.label"
  | "lock.highlights.local.desc"
  | "lock.highlights.browserBound.label"
  | "lock.highlights.browserBound.desc"
  | "lock.highlights.recovery.label"
  ...
  | "connect.state.opening.compact"
  | "connect.state.connected"
  | "connect.state.connected.compact"
  ...
  | "connect.row.sessionId"
  | "connect.row.sessionId.empty"
  | "connect.action.login"
  | "connect.action.login.title"
  | "connect.action.resume"
  | "connect.action.resume.compact"
  ...
  | "connect.action.logout.compact"
  | "connect.action.logout.title"
  | "connect.action.logout.dialogTitle"
  | "connect.action.logout.dialogMessage"
  | "connect.action.logout.confirm"
  | "connect.action.logout.cancel"
  // ----- Sidebar -----
  ...
  | "editor.toolbar.aria"
  | "editor.toolbar.group.block"
  | "editor.toolbar.group.inline"
  | "editor.toolbar.block.paragraph"
  | "editor.toolbar.block.heading1"
  | "editor.toolbar.block.heading2"
  | "editor.toolbar.block.heading3"
  | "editor.toolbar.block.quote"
  | "editor.toolbar.block.bulletList"
  | "editor.toolbar.block.numberedList"
  | "editor.toolbar.block.checkList"
  | "editor.toolbar.block.codeBlock"
  | "editor.toolbar.block.divider"
  | "editor.toolbar.inline.bold"
  | "editor.toolbar.inline.italic"
  | "editor.toolbar.inline.code"
  // ----- Tag input -----
  | "tag.placeholder"
