...
export const messages: Messages = {
  en: {
    ...
    "sidebar.toolbar.action.deleteNote": "Delete file",
    ...
    "editor.loading.note":
      "You can also enable ongoing auto-approval for decrypt requests in Keymaster site settings.",
    "editor.loading.placeholder": "(Decrypting...)",
    "editor.toolbar.aria": "Formatting toolbar",
    "editor.toolbar.group.block": "Block styles",
    "editor.toolbar.group.inline": "Inline styles",
    "editor.toolbar.block.paragraph": "Text",
    "editor.toolbar.block.heading1": "H1",
    "editor.toolbar.block.heading2": "H2",
    "editor.toolbar.block.heading3": "H3",
    "editor.toolbar.block.quote": "Quote",
    "editor.toolbar.block.bulletList": "Bullets",
    "editor.toolbar.block.numberedList": "Numbered",
    "editor.toolbar.block.checkList": "Todo",
    "editor.toolbar.block.codeBlock": "Code",
    "editor.toolbar.block.divider": "Divider",
    "editor.toolbar.inline.bold": "Bold",
    "editor.toolbar.inline.italic": "Italic",
    "editor.toolbar.inline.code": "Inline code",
    // ----- Tag input -----
  ...
  "zh-CN": {
    ...
    "sidebar.toolbar.action.deleteNote": "删除文件",
    ...
    "editor.loading.note": "也可以去 Keymaster 的站点设置里开启持续自动许可解密。",
    "editor.loading.placeholder": "（解密中...）",
    "editor.toolbar.aria": "格式工具栏",
    "editor.toolbar.group.block": "块级格式",
    "editor.toolbar.group.inline": "行内格式",
    "editor.toolbar.block.paragraph": "正文",
    "editor.toolbar.block.heading1": "H1",
    "editor.toolbar.block.heading2": "H2",
    "editor.toolbar.block.heading3": "H3",
    "editor.toolbar.block.quote": "引用",
    "editor.toolbar.block.bulletList": "无序",
    "editor.toolbar.block.numberedList": "有序",
    "editor.toolbar.block.checkList": "任务",
    "editor.toolbar.block.codeBlock": "代码块",
    "editor.toolbar.block.divider": "分割线",
    "editor.toolbar.inline.bold": "粗体",
    "editor.toolbar.inline.italic": "斜体",
    "editor.toolbar.inline.code": "行内码",
    // ----- Tag input -----
  ...
  ja: {
    ...
    "sidebar.toolbar.action.deleteNote": "ファイルを削除",
    ...
    "editor.loading.note":
      "Keymaster のサイト設定で、復号の継続的な自動許可を有効にすることもできます。",
    "editor.loading.placeholder": "（復号中...）",
    "editor.toolbar.aria": "書式ツールバー",
    "editor.toolbar.group.block": "ブロック書式",
    "editor.toolbar.group.inline": "インライン書式",
    "editor.toolbar.block.paragraph": "本文",
    "editor.toolbar.block.heading1": "H1",
    "editor.toolbar.block.heading2": "H2",
    "editor.toolbar.block.heading3": "H3",
    "editor.toolbar.block.quote": "引用",
    "editor.toolbar.block.bulletList": "箇条書き",
    "editor.toolbar.block.numberedList": "番号",
    "editor.toolbar.block.checkList": "TODO",
    "editor.toolbar.block.codeBlock": "コード",
    "editor.toolbar.block.divider": "区切り",
    "editor.toolbar.inline.bold": "太字",
    "editor.toolbar.inline.italic": "斜体",
    "editor.toolbar.inline.code": "インラインコード",
    // ----- Tag input -----
